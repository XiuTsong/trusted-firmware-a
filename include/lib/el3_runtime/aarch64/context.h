...
// Titanium sel2 register
#define CTX_EL1SRE_OFFSET	(CTX_CVE_2018_3639_OFFSET + CTX_CVE_2018_3639_END)
#define CTX_EL1SRE_END		U(0x10) /* Align to the next 16 byte boundary */
/*******************************************************************************
